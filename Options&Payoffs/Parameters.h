...
{
public:
    ParametersPiecewiseConstant(vector<ParametersConstant> constant, vector<double> times);
    virtual ParametersInner* clone() const;
    virtual double Integral(double time1, double time2) const;
    virtual double IntegralSquare(double time1, double time2) const;
private:
    //ParametersConstant Constants[3] = {[0 ... 2] = ParametersConstant(0)};
    vector<ParametersConstant> Constants;
    vector<double> Times;
};
